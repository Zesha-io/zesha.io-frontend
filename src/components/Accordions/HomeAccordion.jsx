    ...
    <div>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel3a-header"
        >
          <Typography>How do I start earning on Zesha as a viewer?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            ...
            <Link href="/individual/payouts" className="underline text-[#046ed1]">Payouts</Link> link on your Dashboard,
            or click on Withdraw on your Chrome extension.
          </Typography>
          <br />
          <Typography>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
            Each ad view earns you 0.1 TFUEL. To see the equivalent amount in
            USD, view this <Link href="https://coinmarketcap.com/currencies/theta-fuel/" target={'_blank'} className='underline text-[#046ed1]'>link.</Link>
          </Typography>
          <br/>
          <Typography>
            
            How much you earn per month depends on how
            active you are on Zesha. During our beta period, a good estimate is
            around $1 - $5 per month. As our users increase, we expect this
          ...
          <Typography>
            ...
            We&apos;ll also be adding more earning options for viewers very soon, including engagement rewards, creator
