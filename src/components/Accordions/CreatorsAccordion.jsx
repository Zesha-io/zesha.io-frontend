    ...
    return (
        <div>
                ...
                <AccordionDetails>
                    <div>
                        <ul>
                            ...
                            <li>
                                <Typography>
                                    Promote your videos so your followers can
                                    watch them on Zesha
                                </Typography>
                            </li>
                            <li>
                                <Typography>
                                    You&apos;ll automatically get paid in your
                                    Zesha wallet.
                                </Typography>
                            </li>
                        </ul>
            ...
            <Accordion>
                ...
                >
                    <Typography>
                        How can I promote Zesha to my followers?
                    </Typography>
                </AccordionSummary>
                <AccordionDetails>
                    <Typography>
                        We want to help you earn more. We have a wide range of
                        promotional resources, including banners, short videos,
                        and scripts you can use to promote Zesha to your fand
                        and followers. To access these resources, please message
                        us on Telegram or send us an email at{" "}
                        <Link
                            href="malito:creators@zesha.io"
                            className="text-[#046ed1] underline"
                        >
                            creators@zesha.io.
                        </Link>
                    </Typography>
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <Typography>
                        ...
                        link on your Creator Dashboard.
                    </Typography>
                    <br />
                    <Typography>
