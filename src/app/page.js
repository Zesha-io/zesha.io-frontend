      ...
      <Layout>
              ...
              <div className="w-3/2">
                <div>
                  <h1 className="text-7xl font-bold font-['Recoleta'] text-[#0B0A1D]">
                    <span className="text-[#F93D3D]">Earn</span> from doing what
                    you <span className="text-[#F93D3D]">love</span>
                  </h1>
                </div>
                <div className="mb-10 mt-5">
                  <p className="text-md">
                    With Zesha, you can earn rewards while enjoying the content
                    you love.
                  </p>
                </div>
        ...
        <section className="pt-12 mt-12 rounded-lg">
            ...
            >
              <defs>
                <linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0">
                  <stop stop-color="rgba(252, 230, 175, 1)" offset="0%"></stop>
                  <stop
          ...
          <div className="container mx-auto px-6 max-w-3xl bg-[#FCE6AF] relative">
            <img src={'/images/videoplay.svg'} className="absolute -bottom-36 right-0 lg:-right-20"/>
            <div className="py-14 px-4  md:px-12 lg:px-20  flex items-center justify-center flex-col">
              ...
              <div>
                <p className=" text-center text-md">
                  At Zesha, we're on a mission to empower creators to make an
                  impact with their content while giving viewers the power to
                  support the content they care about and, at the same time,
                  earn. Join us in creating a world where{' '}
                  ...
                  <div className="order-last md:order-first">
                    <div className="pr-0 lg:pr-16">
                      ...
                      <p className="mb-3 text-base">
                        Getting started on Zesha is easy-peasy. Just install the
                        Zesha Chrome Extension in one-click, and sign up with
                        your social account.
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 py-14 gap-10 md:grid-cols-2 items-center">
                  <div className="order-last md:order-first">
                    <div className="pr-0 lg:pr-16">
                      ...
                      <p className="mb-3 text-base">
                        Set your interests, and we&apos;ll recommend engaging,
                        high-quality videos from your favorite content creators
                ...
                <div className="grid grid-cols-1 py-14 gap-10 md:grid-cols-2 items-center">
                  <div className="order-last md:order-first">
                    <div className="pr-0 lg:pr-16">
                      ...
                      <p className="mb-3 text-base">
                        Share revenues with your favorite creators when you
                        engage with ads on their videos! Get paid in TFUEL, and
                        easily withdraw using gift cards, or even donate to your
                        favorite cause!
                      </p>
                    </div>
                  </div>
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div>
              <div className="mb-9 mx-auto text-center max-w-xl">
                ...
                <p className="text-center text-md">
                  Imagine a world where creators and viewers earn from creating
                  and engaging with the content they love. We&apos;re taking
                  back the power from the big guns!
                </p>
              </div>
                ...
                <div className="col-span-2 py-16 gap-10  bg-[#046ED1] text-white px-4 lg:px-12 rounded-lg flex items-center justify-between lg:flex-nowrap flex-wrap ">
                  <div className="order-first w-full lg:w-1/2">
                    <div className="pr-0 lg:pr-16">
                      ...
                      <p className="mb-3 text-base">
                        Maximize internet time with distraction-free mode. We
                        recommend videos at specific times and let you watch in
                        overlay mode while browsing, zero distractions.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-span-2 lg:col-span-1 py-16 gap-10  bg-[#F4F4F4] px-4 lg:px-12 rounded-lg">
                  <div className="order-last md:order-first">
                    <div className="pr-0 lg:pr-16">
                      ...
                      <p className="mb-3 text-base">
                        Zesha's AI suggests personalized videos based on your
                        interests and viewing habits, ensuring that you only
                        watch what you really love.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-span-2 lg:col-span-1 py-16 gap-10  bg-[#F57373] text-white px-4 lg:px-12 rounded-lg">
                  <div className="order-last md:order-first">
                    <div className="pr-0 lg:pr-16">
                      ...
                      <p className="mb-3 text-base">
                        You can redeem your earnings in the form of gift cards
                        or exclusive Zesha offers. You can also choose to donate
                        to your favorite charity or causes.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-span-2 py-16 gap-10  bg-[#043460] text-white px-4 lg:px-12 rounded-lg flex items-center justify-between lg:flex-nowrap flex-wrap ">
                  <div className="order-first w-full lg:w-1/2">
                    <div className="pr-0 lg:pr-16">
                      ...
                      <p className="mb-3 text-base">
                        Apart from sharing ad revenues, reward your favorite
                        creators with ZeshaTips™, premium subscriptions, and
                        NFTs. Use TFUEL to pay and make a difference!
                      </p>
                    </div>
                  </div>
        ...
        <div>
          <div className="flex items-center justify-between w-full py-5 px-6 max-w-7xl mx-auto container flex-wrap">
            <div className="">
              <h1 className="font-['Recoleta'] text-3xl">Are you a creator?</h1>
